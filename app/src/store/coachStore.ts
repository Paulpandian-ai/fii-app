      ...
      lessons: [
        {
          ...
          screens: [
            ...
            'Scores 1-2 are labeled "Caution." Scores 3-4 are "Weak." Scores 5-6 are "Neutral." Scores 7-8 are "Favorable." Scores 9-10 are "Strong." The higher the score, the more positive factors are aligned.',
          ...
          quiz: [{ question: 'What does an FII Score of 8.5 suggest?', options: ['Guaranteed profit', 'A Strong score with favorable factors', 'Time to exit', 'The stock is overpriced'], correctIndex: 1 }],
        },
        {
        ...
        {
          id: 's4', title: 'Score Labels Explained', xpReward: 10,
          screens: [
            '"Strong" and "Favorable" labels mean the data is positive across multiple dimensions. The stock has strong fundamentals, positive momentum, and manageable risk.',
        ...
        },
        {
          ...
          screens: [
            'Each score comes with a confidence level: LOW, MEDIUM, or HIGH. This tells you how much data supports the assessment.',
            'HIGH confidence means multiple dimensions agree, with strong, recent data. LOW confidence means limited or conflicting data — interpret with more caution.',
            'A "Strong" score with HIGH confidence has more data support than a "Strong" with LOW confidence. Always consider confidence alongside the score itself.',
          ],
          quiz: [{ question: 'A "Strong" score with LOW confidence means:', options: ['Guaranteed profit', 'Some positive indicators but limited data support', 'The stock will crash', 'The analysis is wrong'], correctIndex: 1 }],
        },
        {
          id: 's6', title: 'Signal Changes & Alerts', xpReward: 10,
          screens: [
            'When a stock\'s score label changes (e.g., Neutral → Favorable or Favorable → Caution), it means something significant shifted in the underlying data.',
            'Score changes often correspond to earnings reports, macro events, or technical breakouts/breakdowns. Check the "reasoning" to understand why.',
            'FII sends alerts for score changes in your portfolio and watchlist. These are moments to review the data, not necessarily to act immediately.',
          ],
          quiz: [{ question: 'A score change from Favorable to Caution means:', options: ['You must act now', 'Underlying data has deteriorated — review the factors', 'The stock will crash', 'FII made a mistake'], correctIndex: 1 }],
        },
        {
          id: 's7', title: 'Using Signals Responsibly', xpReward: 10,
          screens: [
            'FII scores are educational tools, not financial advice. Always do your own research and consider your personal situation before making any decisions.',
            'No system is right 100% of the time. FII\'s historical accuracy is strong, but individual scores can miss factors. Use position sizing to manage risk.',
            'The best approach: use FII as a starting point for research. Combine data-driven insights with your own judgment and due diligence.',
          ],
          quiz: [{ question: 'How should you use FII scores?', options: ['Auto-trade every score change', 'As one input combined with your own research', 'Ignore them entirely', 'Only follow Strong scores'], correctIndex: 1 }],
        },
        {
          id: 's8', title: 'Comparing Signals Across Stocks', xpReward: 15,
          screens: [
            'When comparing stocks, look beyond the headline label. A "Strong" with score 9.2 has more favorable factors than a "Favorable" at 7.1.',
            ...
            'Use the Screener tab to filter and sort stocks by score, label, sector, and other criteria. This helps you find the highest-scoring stocks efficiently.',
          ],
          quiz: [{ question: 'When comparing two "Favorable" scores, what else matters?', options: ['Only the stock price', 'The composite score and confidence level', 'The company logo', 'Nothing — all Favorables are equal'], correctIndex: 1 }],
        },
      ],
    },
    {
      ...
      lessons: [
        {
          ...
          quiz: [{ question: 'Is a portfolio of 30 tech stocks well diversified?', options: ['Yes, 30 stocks is plenty', 'No, sector concentration creates correlated risk', 'It depends on the stock prices', 'Yes, if they all have high scores'], correctIndex: 1 }],
        },
        {
          ...
          screens: [
            ...
            'FII\'s Tax Education Calculator identifies potential harvesting opportunities in your portfolio and suggests replacement stocks. It estimates potential tax savings.',
          ],
        ...
        },
        {
          ...
          screens: [
            ...
            'Common approaches: calendar-based (quarterly), threshold-based (when any position drifts 5%+ from target), or score-based (when FII scores change significantly).',
            'FII\'s Portfolio Concentration Insights tool compares your current weights to optimal allocation and shows concentration areas. It factors in tax implications too.',
          ],
        ...
        },
        {
          ...
          screens: [
            ...
            'Before earnings: review FII scores, check analyst estimates, and decide your plan for the volatility. Consider position sizing.',
        ...
        },
        {
          ...
          screens: [
            ...
            'FII gives you tools for each part: Scores (analysis), Portfolio X-Ray (allocation), Portfolio Concentration Insights (adjustments), and Tax Education Calculator (tax efficiency).',
